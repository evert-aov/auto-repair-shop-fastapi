...
from app.workshops.dtos.specialty_dto import (
    SpecialtyResponse, SpecialtyCreate, SpecialtyUpdate
)
from app.workshops.services.specialty_service import SpecialtyService
...
def create_specialty(
    ...
    _auth=Depends(require_permission("specialties:create"))
):
...
def list_specialties(
    db: Session = Depends(get_db),
    _auth=Depends(require_permission("specialties:read"))
):
...
def update_specialty(
    ...
    dto: SpecialtyUpdate,
    db: Session = Depends(get_db),
    _auth=Depends(require_permission("specialties:update"))
):
...
def delete_specialty(
    specialty_id: int,
    db: Session = Depends(get_db),
    _auth=Depends(require_permission("specialties:delete"))
):
