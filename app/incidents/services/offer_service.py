...
class OfferService:
    ...
    async def accept_offer(
        ...
        incident = self.incident_repository.get_by_id(offer.incident_id)
        workshop = self.workshop_repository.get_by_id(offer.workshop_id)
    ...
    async def reject_offer(
        ...
        next_offer = await AssignmentService(self.db).find_and_create_offer(incident)
        return next_offer
    ...
    async def _penalize_workshop(
        ...
        self.workshop_repository.save(workshop)
